...
options = st.multiselect("Признаки",['Регион', 'Адрес', 'Общая площадь', 'Площадь кухни', 'Жилая площадь', 'Количество комнат', 'Номер этажа', 'Количество этажей', 'Год начала строительства дома', 'Дом готов', 'Год завершения строительства дома', 'Материал дома', 'Тип парковки', 'Тип отделки', 'Число балконов', 'Долгота дома', 'Широта дома', 'Число пассажирских лифтов', 'Число грузовых лифтов', 'Ближайшие станции метро', 'Расстояния до метро', 'Тип перемещения до метро', 'Район', 'Квартира - апартаменты?', 'Квартира на аукционе?'])
